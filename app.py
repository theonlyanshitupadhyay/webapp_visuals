...
def index():
    ...
    def style_figure(fig, title):
        ...
        fig.update_layout(
            width=None, height=None  # Let Plotly handle responsive sizing
        )
        return fig
    ...
    fig1 = go.Figure()
    fig1.add_trace(go.Scatter(x=df['Timestamp'], y=df['Values'], mode='lines', name='Original Data',
                              hovertemplate='Timestamp: %{x}<br>Voltage: %{y:.2f} V'))
    fig1.add_trace(go.Scatter(x=df['Timestamp'], y=df['Moving_Avg_1000'], mode='lines', name='MA 1000',
                              hovertemplate='Timestamp: %{x}<br>Voltage: %{y:.2f} V'))
    fig1.add_trace(go.Scatter(x=df['Timestamp'], y=df['Moving_Avg_5000'], mode='lines', name='MA 5000',
                              hovertemplate='Timestamp: %{x}<br>Voltage: %{y:.2f} V'))
    ...
    fig2 = go.Figure()
    fig2.add_trace(go.Scatter(x=df['Timestamp'], y=df['Values'], mode='lines', name='Original Data',
                              hovertemplate='Timestamp: %{x}<br>Voltage: %{y:.2f} V'))
    fig2.add_trace(go.Scatter(x=df.iloc[peaks]['Timestamp'], y=df.iloc[peaks]['Values'], mode='markers', name='Peaks',
                              hovertemplate='Timestamp: %{x}<br>Voltage: %{y:.2f} V'))
    fig2.add_trace(go.Scatter(x=df.iloc[lows]['Timestamp'], y=df.iloc[lows]['Values'], mode='markers', name='Lows',
                              hovertemplate='Timestamp: %{x}<br>Voltage: %{y:.2f} V'))
    ...
    fig3 = go.Figure()
    fig3.add_trace(go.Scatter(x=df['Timestamp'], y=df['Values'], mode='lines', name='Original Data',
                              hovertemplate='Timestamp: %{x}<br>Voltage: %{y:.2f} V'))
    fig3.add_trace(go.Scatter(x=below_threshold['Timestamp'], y=below_threshold['Values'], mode='markers',
                              name=f'Below {threshold}', hovertemplate='Timestamp: %{x}<br>Voltage: %{y:.2f} V'))
    ...
    fig4 = go.Figure()
    fig4.add_trace(go.Scatter(x=df['Timestamp'], y=df['Values'], mode='lines', name='Voltage',
                              hovertemplate='Timestamp: %{x}<br>Voltage: %{y:.2f} V'))
    fig4.add_trace(go.Scatter(x=accel_df['Timestamp'], y=accel_df['Values'], mode='markers', name='Acceleration Points',
                              hovertemplate='Timestamp: %{x}<br>Voltage: %{y:.2f} V'))
